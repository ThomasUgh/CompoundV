...
public final class ConfigMigrationService {
    ...
    private boolean migrateVersion111Step32Defaults() {
        ...
        changed |= setIfMissing("abilities.the_veteran.burst_cooldown_ms", 300000);
        changed |= setIfMissing("abilities.the_veteran.ground_zero_radius", 14.0);
        changed |= setIfMissing("abilities.the_veteran.ground_zero_damage", 525.0);
        ...
        changed |= setIfMissing("abilities.the_veteran.ground_zero_knockback", 0.12);
        ...
        changed |= setIfMissing("abilities.the_veteran.ground_zero_set_fire", true);
        changed |= replaceIfNumericEquals("abilities.the_veteran.ground_zero_particle_multiplier", 0.75, 0.35);
        changed |= replaceIfNumericEquals("abilities.the_veteran.ground_zero_particle_multiplier", 0.65, 0.35);
        changed |= replaceIfNumericEquals("abilities.the_veteran.ground_zero_particle_multiplier", 0.45, 0.35);
        changed |= setIfMissing("abilities.the_veteran.ground_zero_particle_multiplier", 0.35);

        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_duration_ticks", 100.0, 70);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_duration_ticks", 80.0, 70);
        changed |= setIfMissing("abilities.the_veteran.beam_duration_ticks", 70);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_period_ticks", 2.0, 4);
        changed |= setIfMissing("abilities.the_veteran.beam_period_ticks", 4);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_range", 53.0, 50.0);
        changed |= setIfMissing("abilities.the_veteran.beam_range", 50.0);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_radius", 1.35, 1.25);
        changed |= setIfMissing("abilities.the_veteran.beam_radius", 1.25);
        changed |= setIfMissing("abilities.the_veteran.beam_full_damage_range", 7.0);
        changed |= setIfMissing("abilities.the_veteran.beam_far_damage_multiplier", 0.5);
        changed |= setIfMissing("abilities.the_veteran.beam_damage_multiplier", 5.0);
        ...
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_damage_interval_ticks", 2.0, 4);
        changed |= setIfMissing("abilities.the_veteran.beam_damage_interval_ticks", 6);
        changed |= setIfMissing("abilities.the_veteran.beam_entity_scan_interval_ticks", 6);
        changed |= setIfMissing("abilities.the_veteran.beam_max_entity_hits_per_pulse", 6);
        changed |= setIfMissing("abilities.the_veteran.beam_particle_interval_ticks", 3);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_particle_step", 0.65, 0.85);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_particle_step", 0.55, 0.85);
        changed |= setIfMissing("abilities.the_veteran.beam_particle_step", 0.85);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_particle_density_multiplier", 0.70, 0.45);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_particle_density_multiplier", 1.15, 0.45);
        changed |= setIfMissing("abilities.the_veteran.beam_particle_density_multiplier", 0.45);
        changed |= setIfMissing("abilities.the_veteran.beam_particle_start_distance", 1.8);
        changed |= setIfMissing("abilities.the_veteran.beam_hit_particles", 5);
        changed |= setIfMissing("abilities.the_veteran.beam_sound_duration_ticks", 35);
        changed |= setIfMissing("abilities.the_veteran.beam_sound_period_ticks", 20);

        changed |= setIfMissing("abilities.the_veteran.beam_break_blocks", true);
        changed |= setIfMissing("abilities.the_veteran.beam_ignite_blocks", true);
        changed |= setIfMissing("abilities.the_veteran.beam_surface_only", true);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_block_affect_interval_ticks", 4.0, 8);
        changed |= setIfMissing("abilities.the_veteran.beam_block_affect_interval_ticks", 12);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_max_blocks_per_pulse", 5.0, 1);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_max_blocks_per_pulse", 2.0, 1);
        changed |= setIfMissing("abilities.the_veteran.beam_max_blocks_per_pulse", 1);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_block_hits_to_break", 5.0, 7);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_block_hits_to_break", 6.0, 7);
        changed |= setIfMissing("abilities.the_veteran.beam_block_hits_to_break", 7);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_block_damage_multiplier", 1.21, 1.0);
        changed |= setIfMissing("abilities.the_veteran.beam_block_damage_multiplier", 1.0);
        changed |= setIfMissing("abilities.the_veteran.beam_block_particles", 1);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_hit_knockback", 0.025, 0.02);
        changed |= setIfMissing("abilities.the_veteran.beam_hit_knockback", 0.02);
        changed |= setIfMissing("abilities.the_veteran.beam_hit_vertical_knockback", 0.0);
        changed |= replaceIfNumericEquals("abilities.the_veteran.beam_hit_max_horizontal_velocity", 0.16, 0.12);
        changed |= setIfMissing("abilities.the_veteran.beam_hit_max_horizontal_velocity", 0.12);
        changed |= setIfMissing("abilities.the_veteran.beam_hit_max_vertical_velocity", 0.02);
        changed |= setIfMissing("abilities.the_veteran.beam_removes_player_abilities", true);

        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud_enabled", true);
        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud_delay_after_beam_ticks", 30);
        changed |= replaceIfNumericEquals("abilities.the_veteran.mushroom_cloud_duration_ticks", 2400.0, 500);
        changed |= replaceIfNumericEquals("abilities.the_veteran.mushroom_cloud_duration_ticks", 1200.0, 500);
        changed |= replaceIfNumericEquals("abilities.the_veteran.mushroom_cloud_duration_ticks", 800.0, 500);
        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud_duration_ticks", 500);
        changed |= replaceIfNumericEquals("abilities.the_veteran.mushroom_cloud_period_ticks", 12.0, 20);
        changed |= replaceIfNumericEquals("abilities.the_veteran.mushroom_cloud_period_ticks", 16.0, 20);
        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud_period_ticks", 20);
        changed |= replaceIfNumericEquals("abilities.the_veteran.mushroom_cloud_height", 32.0, 26.0);
        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud_height", 26.0);
        changed |= replaceIfNumericEquals("abilities.the_veteran.mushroom_cloud_radius", 15.5, 12.0);
        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud_radius", 12.0);
        changed |= replaceIfNumericEquals("abilities.the_veteran.mushroom_cloud_particle_multiplier", 0.78, 0.30);
        changed |= replaceIfNumericEquals("abilities.the_veteran.mushroom_cloud_particle_multiplier", 0.65, 0.30);
        changed |= replaceIfNumericEquals("abilities.the_veteran.mushroom_cloud_particle_multiplier", 0.45, 0.30);
        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud_particle_multiplier", 0.30);
        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud_sound_duration_ticks", 30);
