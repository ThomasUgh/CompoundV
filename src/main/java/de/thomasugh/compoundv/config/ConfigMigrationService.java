...
public final class ConfigMigrationService {
    ...
    private boolean migrateVersion111Step32Defaults() {
        ...
        changed |= replaceIfNumericEquals("abilities.the_veteran.ground_zero.particle_multiplier", 0.22, 0.16);
        changed |= replaceIfNumericEquals("abilities.the_veteran.chest_beam.tick_period", 5.0, 6);
        changed |= replaceIfNumericEquals("abilities.the_veteran.chest_beam.damage_interval_ticks", 5.0, 6);
        changed |= replaceIfNumericEquals("abilities.the_veteran.chest_beam.particle_interval_ticks", 10.0, 12);
        changed |= replaceIfNumericEquals("abilities.the_veteran.chest_beam.particle_step", 1.35, 1.55);
        changed |= replaceIfNumericEquals("abilities.the_veteran.chest_beam.particle_multiplier", 0.24, 0.18);
        changed |= replaceIfNumericEquals("abilities.the_veteran.chest_beam.entity_scan_interval_ticks", 10.0, 12);
        ...
        changed |= replaceIfNumericEquals("abilities.the_veteran.mushroom_cloud.radius", 8.0, 6.0);
        changed |= replaceIfNumericEquals("abilities.the_veteran.mushroom_cloud.particle_multiplier", 0.18, 0.10);

        changed |= setIfMissing("abilities.the_veteran.ground_zero.enabled", true);
        changed |= setIfMissing("abilities.the_veteran.ground_zero.radius", 12.0);
        changed |= setIfMissing("abilities.the_veteran.ground_zero.damage_hearts", 5.0);
        changed |= setIfMissing("abilities.the_veteran.ground_zero.scale_damage_by_distance", false);
        changed |= setIfMissing("abilities.the_veteran.ground_zero.player_damage_multiplier", 1.0);
        changed |= setIfMissing("abilities.the_veteran.ground_zero.entity_damage_multiplier", 1.0);
        changed |= setIfMissing("abilities.the_veteran.ground_zero.max_targets", 32);
        changed |= setIfMissing("abilities.the_veteran.ground_zero.particles_enabled", true);
        changed |= setIfMissing("abilities.the_veteran.ground_zero.particle_multiplier", 0.16);
        changed |= setIfMissing("abilities.the_veteran.ground_zero.sounds_enabled", true);
        changed |= setIfMissing("abilities.the_veteran.ground_zero.set_fire", false);

        changed |= setIfMissing("abilities.the_veteran.chest_beam.enabled", true);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.duration_ticks", 70);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.tick_period", 6);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.range", 46.0);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.radius", 1.6);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.damage_hearts_per_tick", 1.0);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.damage_interval_ticks", 6);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.player_damage_enabled", true);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.player_damage_multiplier", 1.0);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.entity_damage_multiplier", 1.0);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.particles_enabled", true);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.particle_interval_ticks", 12);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.particle_step", 1.55);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.particle_multiplier", 0.18);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.entity_scan_interval_ticks", 12);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.max_entity_hits_per_pulse", 4);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.sounds_enabled", true);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.block_damage.enabled", true);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.block_damage.ignite_blocks", false);
        ...
        changed |= setIfMissing("abilities.the_veteran.chest_beam.particle_start_distance", 0.7);
        changed |= setIfMissing("abilities.the_veteran.chest_beam.hit_particles", 1);

        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud.enabled", true);
        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud.delay_after_beam_ticks", 30);
        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud.duration_ticks", 160);
        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud.period_ticks", 40);
        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud.height", 13.0);
        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud.radius", 6.0);
        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud.particle_multiplier", 0.10);
        changed |= setIfMissing("abilities.the_veteran.mushroom_cloud.sound_duration_ticks", 0);
